      ...
      <br/>
         ...
         <div class='col-twelve animate-this' data-animate="fadeInLeft">
               ...
               <img style='border:solid 2px black;display:inline-block;float:right;width:50%;margin-left:2%;' src='images/mockup/1paperMockup.PNG'>
      ...
      <br/>
         ...
         <div class='col-twelve animate-this' data-animate="fadeInRight">
            ...
            <img style='border:solid 2px black;display:inline-block;float:left;width:50%;margin-right:2%;' src='images/mockup/2compMockup.PNG'>
            ...
            <p>The homepage was generally designed with some JavaScript ideas as well however those were notes for later (including rotating the top three images and blinking the 3X3 grid under the LOGO/NAME/DESIGN). This also helped organize how the secondary pages would work within the navigation menu and what would be featured
      ...
      <br/>
         ...
         <div class='col-twelve animate-this' data-animate="fadeInLeft">
               ...
               <img style='border:solid 2px black;display:inline-block;float:right;width:50%;margin-left:2%;' src='images/mockup/3-01finalHTML.JPG'>
            <img style='border:solid 2px black;display:inline-block;float:right;width:50%;margin-left:2%;' src='images/mockup/3-02finalHTML.JPG'>
            <img style='border:solid 2px black;display:inline-block;float:right;width:50%;margin-left:2%;' src='images/mockup/3-03finalHTML.JPG'>
